...
function CreateEvent() {
    ...
    const minEventDate = startDate? new Date(startDate.getTime() + 3 * 24 * 60 * 60 * 1000).toISOString().slice(0,10) : today
        ...
        <div className='w-[90%] md:w-[50px] bg-white shadow h-[80vh] rounded-[4px] p-3 overflow-y-scroll'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <select
                        className='w-full mt-2 border h-[35px] roudned-[5px]'
                ...
                <div>
                    ...
                    <input type="number" name='price' value={originalPrice}
                        className='mt-2 appearance-none block w-full px-3 h-[35px] border border-gray-300 rounded-[3px] placeholder-gray-400 focus:outline-none focus:ring-blue-500 sm:text-sm'
                ...
                <div>
                    ...
                    <input type="number" name='discount-price' value={discountPrice}
                        className='mt-2 appearance-none block w-full px-3 h-[35px] border border-gray-300 rounded-[3px] placeholder-gray-400 focus:outline-none focus:ring-blue-500 sm:text-sm'
                ...
                <div>
                    ...
                    <input type="date" name='start-date' value={startDate? startDate.toISOString().slice(0, 10): ""}
                        className='mt-2 appearance-none block w-full px-3 h-[35px] border border-gray-300 rounded-[3px] placeholder-gray-400 focus:outline-none focus:ring-blue-500 sm:text-sm'
