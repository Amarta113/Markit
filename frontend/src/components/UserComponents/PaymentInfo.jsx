...
const PaymentInfo = (
  ...
  return (
    <>
      ...
      {/* Paypal payment */}
      <div>
        <div className="flex w-full pb-5 broder-b mb-2">
              ...
              </div>
              {
                open && (
                  <div className="w-full fixed top-0 left-0 bg-[#00000039] h-screen flex items-center justify-center z-[999999]">
                    <div className="w-full width-800px-40 h-screen height-at-800px bg-white rounded-[5px] justify-center p-8 relaticve overflow-y-scroll">
      ...
      <div>
        <div className="flex w-full pb-5 border-b mb-2">
          <div className="w-[25px] h-[25px] rounded-full bg-transparent border-[3px] border-[#1d1a1ab4] relative flex items-center justify-center"
            ...
            {
              select == 3 ? (
                <div className="w-[13px] bg-[#1d1a1acb] rounded-full" />
              ) : null
            }
          </div>
          <h4 className='text-[18px] pl-2 font-[600] text-[#000000b1]'>
